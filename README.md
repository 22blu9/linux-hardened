...
### This project is still under dispute as of which chipset it'll use, so these plans might be changed. For now, it is a project for tinkering and is insignificant.